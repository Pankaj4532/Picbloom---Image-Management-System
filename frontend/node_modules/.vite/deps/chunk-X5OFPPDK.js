...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React10.useMemo(() => storageManager?.({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React10.useMemo(() => storageManager?.({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React10.useMemo(() => storageManager?.({
...
function prepareCssVars(theme, parserConfig = {}) {
  ...
  const generateThemeVars = () => {
    ...
    Object.entries(colorSchemesMap).forEach(([, {
      ...
      vars = deepmerge2(vars, schemeVars);
    });
    return vars;
  };
...
} });` : formatMuiErrorMessage2(12, name ? ` (${name})` : "", JSON.stringify(color.main)));
    }
...
function createThemeNoVars(options = {}, ...args) {
  ...
  options.generateThemeVars === void 0) {
    throw new Error(true ? "MUI: `vars` is a private field used for CSS variables support.\nPlease use another name or follow the [docs](https://mui.com/material-ui/customization/css-theme-variables/usage/) to enable the feature." : formatMuiErrorMessage2(20));
  }
  const palette = createPalette(paletteInput);
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-X5OFPPDK.js.map
