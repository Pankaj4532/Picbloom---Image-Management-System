...
// node_modules/@mui/styles/node_modules/@mui/private-theming/ThemeProvider/ThemeProvider.js
...
var StylesContext = React18.createContext(defaultOptions);
if (true) {
...
function StylesProvider(props) {
  ...
  const outerOptions = React18.useContext(StylesContext);
  const {
    generateClassName,
    jss,
...
function useSynchronousEffect(func, values) {
  const key = React19.useRef([]);
  let output;
  const currentKey = React19.useMemo(() => ({}), values);
...
function makeStyles(stylesOrCreator, options = {}) {
  ...
  const useStyles = (props = {}) => {
    ...
    const stylesOptions = {
      ...React19.useContext(StylesContext),
      ...stylesOptions2
    };
    const instance = React19.useRef();
    const shouldUpdate = React19.useRef();
...
var ServerStyleSheets = class {
  ...
  getStyleElement(props) {
    return React20.createElement("style", {
      id: "jss-server-side",
      key: "jss-server-side",
...
function styled(Component) {
  const componentCreator = (style, options = {}) => {
    ...
    const StyledComponent = React21.forwardRef(function StyledComponent2(props, ref) {
      const {
        children,
    ...
    true ? StyledComponent.propTypes = {
       ...
       */
      clone: chainPropTypes(import_prop_types6.default.bool, (props) => {
...
var withStyles = (stylesOrCreator, options = {}) => (Component) => {
  ...
  const WithStyles = React22.forwardRef(function WithStyles2(props, ref) {
    const {
      classes: classesProp,
      ...other
    } = props;
...
function withThemeCreator(options = {}) {
  ...
  const withTheme2 = (Component) => {
    ...
    const WithTheme = React23.forwardRef(function WithTheme2(props, ref) {
      const theme = useTheme2() || defaultTheme;
