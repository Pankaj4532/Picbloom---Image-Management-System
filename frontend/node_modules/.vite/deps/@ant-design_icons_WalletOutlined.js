...
var require_WalletOutlined2 = __commonJS({
  "node_modules/@ant-design/icons/lib/icons/WalletOutlined.js"(exports) {
    ...
    var _WalletOutlined = _interopRequireDefault(require_WalletOutlined());
    ...
    var WalletOutlined = (props, ref) => React.createElement(_AntdIcon.default, _extends({}, props, {
      ref,
      icon: _WalletOutlined.default
    }));
    var RefIcon = React.forwardRef(WalletOutlined);
    if (true) {
