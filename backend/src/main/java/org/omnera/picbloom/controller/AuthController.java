...
import org.omnera.picbloom.payload.auth.AccountDTO;
import org.omnera.picbloom.payload.auth.AccountViewDTO;
import org.omnera.picbloom.payload.auth.AuthoritiesDTO;
import org.omnera.picbloom.payload.auth.PasswordDTO;
import org.omnera.picbloom.payload.auth.ProfileDTO;
import org.omnera.picbloom.payload.auth.TokenDTO;
import org.omnera.picbloom.payload.auth.UserLoginDTO;
import org.omnera.picbloom.service.AccountService;
import org.omnera.picbloom.service.TokenService;
import org.omnera.picbloom.util.constants.AccountError;
import org.omnera.picbloom.util.constants.AccountSuccess;
...
public class AuthController {
    ...
    public ResponseEntity<TokenDTO> token(@Valid @RequestBody UserLoginDTO userLogin) throws AuthenticationException {
        ...
        try {
            // using the injected instance, not the interface
            Authentication authentication = authenticationManager.authenticate(
                    new UsernamePasswordAuthenticationToken(userLogin.getEmail(), userLogin.getPassword()));

            // return token wrapped in DTO
    ...
    @SecurityRequirement(name="omnera-demo-api")
    public ResponseEntity<AccountViewDTO> update_password(@Valid @RequestBody PasswordDTO passwordDTO,Authentication authentication){
